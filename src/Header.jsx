...
import { Menu, Search, Plus, Bell, Settings, ChevronDown } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <p className="text-slate-500 dark:text-slate-400">Welcome back, İkbal! here's what's happening today</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
            ...
            <span className="absolute -top-1 right-0 w-5 h-5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center">3</span>
          </button>
          ...
          <div className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700">
            <img src={profilFoto} alt="User" className="w-8 h-8 rounded-full ring-2 ring-blue-500" />
            <div className="hidden md:block">
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">İkbal İrem Erdoğan</p>
